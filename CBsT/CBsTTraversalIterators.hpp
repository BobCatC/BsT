...
private:
	...
	public:
		iterator_traversal(CRootNode* root) :
		_crt(root),
...
public:
	...
	public:
		...
		iteratorPreorderDF(CRootNode* root) : iterator_traversal(root) {
			instruction = go_down_left;
		}
...
public:
	...
	public:
		...
		iteratorPostorderDF(CRootNode* root) : iterator_traversal(root) {
			instruction = go_down_left;
...
public:
	...
	public:
		...
		iteratorInorderDF(CRootNode* root) : iterator_traversal(root) {
			instruction = go_down_left;
			if(!iterator_traversal::_fIsAfterLastNode)
				findNext();
		}
